...
from pgantics import JSONB, BigSerial, Column, Table, TimestampTZ, default, validate
...
class User(Table):
    ...
    created_at: datetime.datetime = Column(TimestampTZ(), default=default.CurrentTimestamp("UTC"), nullable=False)
